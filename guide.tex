...
\subsection{Nuances entre votre exercices & les différents types de contrôles}
\begin{figure}[htbp]
\begin{center}
...
\item \textbf{Contrôles:} dans cette partie, il y a les contrôles & devoirs maisons (aussi sélectionnés par vos professeurs).
\end{itemize}
...
\subsection{Nuances entre votre compte & la classe}
\LARGE
Attention!\\
\Large
